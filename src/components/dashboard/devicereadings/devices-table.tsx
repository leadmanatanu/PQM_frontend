                ...
                <Box sx={{ p: 6, textAlign: 'center' }}>
                    <Stack spacing={2} alignItems="center" justifyContent="center">
                        ...
                        <Typography variant="body1" fontWeight={600}>
                            {scanStatusText || 'Connecting to DLMS meter and scanning live values...'}
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                            {scanStatusText?.includes('waiting')
                                ? 'A sync operation is in progress. Your scan will start automatically as soon as the meter is free.'
                                : 'Establishing real-time TCP connection to meter. Please wait.'}
                        </Typography>
                    </Stack>
                </Box>
            </Card>
