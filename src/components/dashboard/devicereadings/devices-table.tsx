...
export function DeviceRTable({
    ...
    const formattedScannedAt = scannedAt
        ? dayjs(scannedAt).format("YYYY-MM-DD HH:mm:ss")
        : null;
            ...
            <Card sx={{ maxWidth: "1400px", width: "100%", borderRadius: "8px" }}>
                <Box sx={{ p: 6, textAlign: "center" }}>
                    <Typography color="text.secondary">
                        Select a device and click <strong>Scan</strong> to read current live
                        meter values in real-time.
                    </Typography>
                </Box>
            </Card>
        );
    ...
    return (
        <Card sx={{ maxWidth: "1400px", width: "100%", borderRadius: "8px" }}>
            ...
            {groups.map((group) => {
                ...
                const errorCount = group.items.filter(
                    (item) => item.error || item.value === "N/A"
                ).length;
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <Chip
                                    label={`${group.items.length} param${
            ...
            >
                <Typography variant="caption" color="text.secondary">
                    ...
                    {groups.length === 1 ? "" : "s"} · Total live parameters
                    scanned: {totalCount}
                </Typography>
            </Box>
        </Card>
