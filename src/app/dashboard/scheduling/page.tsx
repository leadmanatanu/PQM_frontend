...
export default function SchedulingPage(): React.JSX.Element {
    ...
    const [modalTime, setModalTime] =
        React.useState<string>('00:00');

    const [selectedScheduleId, setSelectedScheduleId] =
        React.useState<number | null>(null);

    const [savingModal, setSavingModal] =
    ...
    const handleOpenEditModal = (
        ...
        setModalTime(
            row.scheduledTime
                ? row.scheduledTime.substring(0, 5)
                : '00:00'
        );
    ...
    const handleSaveSchedule = async () => {
        ...
        try {
            ...
            if (modalMode === 'create') {
                ...
                res = await createDeviceSchedule(
                    payload
                );
            ...
            // ----------------------------
                ...
                res = await updateDeviceSchedule(
                    selectedScheduleId,
                    payload
                );
            }
    ...
    const formatScheduledTimeDisplay = (
        timeStr?: string
    ) => {
    ...
    const isSyncEngineOffline =
        schedules.some(schedule => {
            ...
            const lastRun = new Date(
                schedule.lastRunAtUtc.endsWith('Z')
                    ? schedule.lastRunAtUtc
                    : schedule.lastRunAtUtc + 'Z'
            );
        ...
        <Box sx={{ p: 0 }}>
            ...
            {isSyncEngineOffline && (
                ...
                >
                    ...
                    One or more enabled schedules have not
                    executed a successful run in over 26 hours.
                    The PQMMeterReader Windows service or sync
